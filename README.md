...
* Предсказание стоимости аренды недвижимости в Лондоне по характеристикам квартир, отзывам на них и календарю. [ipynb](https://github.com/danidarya/machine_learning_projects/blob/master/airbnb_price_prediction/airbnb_London_price_prediction.ipynb) 
...
* Определение токсичных комментариев [ipynb](https://github.com/danidarya/machine_learning_projects/blob/master/toxic_comments_classification/toxic_comments_classification.ipynb)
